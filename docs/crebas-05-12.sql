...
prompt Created on 2011年5月12日 by maxim
set feedback off
set define off
...
insert into CUT_ROLE (ROLE_ID, ROLE_NAME, ROLE_MEMO)
values (2, '割接总负责人', '可以对用户进行管理，可以配置割接基本信息；可浏览总体割接进度；');
insert into CUT_ROLE (ROLE_ID, ROLE_NAME, ROLE_MEMO)
values (3, '总体进度观察', '仅可以浏览总体割接进度');
insert into CUT_ROLE (ROLE_ID, ROLE_NAME, ROLE_MEMO)
values (11, '步骤负责人', '可以对步骤、任务做配置和执行；可浏览总体割接进度；');
insert into CUT_ROLE (ROLE_ID, ROLE_NAME, ROLE_MEMO)
values (12, '步骤检查人', '仅可以对步骤完成情况做检查；可浏览总体割接进度；');
insert into CUT_ROLE (ROLE_ID, ROLE_NAME, ROLE_MEMO)
values (21, '子任务操作人', '可以对任务做配置和执行操作；可浏览总体割接进度；');
insert into CUT_ROLE (ROLE_ID, ROLE_NAME, ROLE_MEMO)
...
insert into CUT_STEP (STEP_ID, STEP_NAME, STEP_WEIGHT_VALUE, STEP_CUR_PERCENT, STEP_TIMES, STEP_OWNER_ID, STEP_CHECKER_ID, STEP_INDEX, STEP_STATUS)
values (1119, '周边系统配合割接', 30, 33, 120, 1113, 1113, 4, 1);
insert into CUT_STEP (STEP_ID, STEP_NAME, STEP_WEIGHT_VALUE, STEP_CUR_PERCENT, STEP_TIMES, STEP_OWNER_ID, STEP_CHECKER_ID, STEP_INDEX, STEP_STATUS)
values (1116, '应用部署检查', 10, 85, 200, 1101, 1102, 1, 1);
insert into CUT_STEP (STEP_ID, STEP_NAME, STEP_WEIGHT_VALUE, STEP_CUR_PERCENT, STEP_TIMES, STEP_OWNER_ID, STEP_CHECKER_ID, STEP_INDEX, STEP_STATUS)
values (1117, '基础数据检查', 30, 60, 140, 1111, 1104, 2, 1);
commit;
...
insert into CUT_TASK (TASK_ID, TASK_NAME, TASK_OPERATER_ID, TASK_CHECKER_ID, TASK_TIMES, STEP_ID, TASK_SHELL_COMMAND, TASK_INDEX, TASK_STATUS)
values (1128, '屏蔽语音流程、播放割接通告', 1112, 1112, 30, 1119, null, 1, 2);
insert into CUT_TASK (TASK_ID, TASK_NAME, TASK_OPERATER_ID, TASK_CHECKER_ID, TASK_TIMES, STEP_ID, TASK_SHELL_COMMAND, TASK_INDEX, TASK_STATUS)
...
insert into CUT_TASK (TASK_ID, TASK_NAME, TASK_OPERATER_ID, TASK_CHECKER_ID, TASK_TIMES, STEP_ID, TASK_SHELL_COMMAND, TASK_INDEX, TASK_STATUS)
values (1135, '割接程序目录部署检查', 1114, 1114, 20, 1117, '"cd /gpfs1/oce ' || chr(13) || '' || chr(10) || './bin' || chr(13) || '' || chr(10) || './cfg' || chr(13) || '' || chr(10) || './newdata' || chr(13) || '' || chr(10) || './olddata' || chr(13) || '' || chr(10) || './log' || chr(13) || '' || chr(10) || './temp"' || chr(13) || '' || chr(10) || '', 1, 2);
insert into CUT_TASK (TASK_ID, TASK_NAME, TASK_OPERATER_ID, TASK_CHECKER_ID, TASK_TIMES, STEP_ID, TASK_SHELL_COMMAND, TASK_INDEX, TASK_STATUS)
values (1136, '割接程序及配置文件部署检查', 1114, 1114, 30, 1117, null, 2, 0);
insert into CUT_TASK (TASK_ID, TASK_NAME, TASK_OPERATER_ID, TASK_CHECKER_ID, TASK_TIMES, STEP_ID, TASK_SHELL_COMMAND, TASK_INDEX, TASK_STATUS)
values (1137, '割接环境变量检查', 1114, 1114, 30, 1117, null, 3, 3);
insert into CUT_TASK (TASK_ID, TASK_NAME, TASK_OPERATER_ID, TASK_CHECKER_ID, TASK_TIMES, STEP_ID, TASK_SHELL_COMMAND, TASK_INDEX, TASK_STATUS)
values (1138, '数据入库脚本检查', 1114, 1114, 30, 1117, null, 4, 2);
insert into CUT_TASK (TASK_ID, TASK_NAME, TASK_OPERATER_ID, TASK_CHECKER_ID, TASK_TIMES, STEP_ID, TASK_SHELL_COMMAND, TASK_INDEX, TASK_STATUS)
