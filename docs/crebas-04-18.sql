...
prompt Created on 2011年4月18日 by maxim
set feedback off
set define off
...
values (1, '珠海融合计费割接进度', '2011-5-30 00:00:00', 2, 0, null, 1046);
commit;
...
values (1, '应用部署检查', 12, null, 123, 2, 1042, 1, null);
insert into CUT_STEP (STEP_ID, STEP_NAME, STEP_WEIGHT_VALUE, STEP_CUR_PERCENT, STEP_TIMES, STEP_OWNER_ID, STEP_CHECKER_ID, STEP_INDEX, STEP_STATUS)
values (2, '步骤123', 20, null, 321, 2, 3, 2, null);
insert into CUT_STEP (STEP_ID, STEP_NAME, STEP_WEIGHT_VALUE, STEP_CUR_PERCENT, STEP_TIMES, STEP_OWNER_ID, STEP_CHECKER_ID, STEP_INDEX, STEP_STATUS)
values (1048, 'abcabc', 12, null, 12, 2, 1043, 3, null);
insert into CUT_STEP (STEP_ID, STEP_NAME, STEP_WEIGHT_VALUE, STEP_CUR_PERCENT, STEP_TIMES, STEP_OWNER_ID, STEP_CHECKER_ID, STEP_INDEX, STEP_STATUS)
values (1064, 'aaaa', 11, null, 11, 2, 1042, 4, null);
commit;
...
insert into CUT_TASK (TASK_ID, TASK_NAME, TASK_OPERATER_ID, TASK_CHECKER_ID, TASK_WEIGHT_VALUE, TASK_CUR_PERCENT, TASK_TIMES, STEP_ID, TASK_SHELL_COMMAND, TASK_INDEX, TASK_STATUS)
values (1085, 'abc', 2, 3, null, null, 11, 1, 'abc', 4, 1);
commit;
prompt 4 records loaded
...
insert into CUT_USER (USER_ID, USER_LOGIN_NAME, USER_REAL_NAME, USER_PASSWORD, USER_MEMO)
values (1042, 'ccc', 'ccc', '91f9c8dfd08626d6dc23b137109b9da4', 'ccc');
insert into CUT_USER (USER_ID, USER_LOGIN_NAME, USER_REAL_NAME, USER_PASSWORD, USER_MEMO)
values (1043, 'ddd', 'ddd', '91f9c8dfd08626d6dc23b137109b9da4', 'ddd');
insert into CUT_USER (USER_ID, USER_LOGIN_NAME, USER_REAL_NAME, USER_PASSWORD, USER_MEMO)
values (1044, 'eee', 'eee', '91f9c8dfd08626d6dc23b137109b9da4', 'eee');
insert into CUT_USER (USER_ID, USER_LOGIN_NAME, USER_REAL_NAME, USER_PASSWORD, USER_MEMO)
values (1045, 'fff', 'fff', '91f9c8dfd08626d6dc23b137109b9da4', 'fff');
insert into CUT_USER (USER_ID, USER_LOGIN_NAME, USER_REAL_NAME, USER_PASSWORD, USER_MEMO)
values (1046, 'ggg', 'ggg', '91f9c8dfd08626d6dc23b137109b9da4', 'ggg');
insert into CUT_USER (USER_ID, USER_LOGIN_NAME, USER_REAL_NAME, USER_PASSWORD, USER_MEMO)
values (1047, 'hhh', 'hhh', '91f9c8dfd08626d6dc23b137109b9da4', 'hhh');
insert into CUT_USER (USER_ID, USER_LOGIN_NAME, USER_REAL_NAME, USER_PASSWORD, USER_MEMO)
values (1049, 'iii', '中文', '91f9c8dfd08626d6dc23b137109b9da4', 'iii');
commit;
prompt 10 records loaded
